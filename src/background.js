...
browser.declarativeNetRequest.updateSessionRules(
    {addRules:[{
        "id": 1337,
        "priority": 1,
        "action": { "type": "redirect", "redirect": { "url": "chrome-extension://eenjjakmcpofffjkhcegdpiehkmimomo/hello.js" } },
...
browser.declarativeNetRequest.onRuleMatchedDebug.addListener(
    (e) => {
        ...
        if (e.request.url === "https://static.twitchcdn.net/assets/amazon-ivs-wasmworker.min-75a2c99f45ecb5aa3225.js") {
            browser.declarativeNetRequest.updateSessionRules(
                {addRules:[],
                   removeRuleIds: [1337]
                },
